...
import TestimonialImg01 from "@/public/images/ieee.png";
import ClientImg01 from "@/public/images/ieeants-p.svg";
import ClientImg02 from "@/public/images/comsnets-p.svg";
...
const testimonials = [
  {
    ...
    company: "Conference",
    content:
      "AURA: Adaptive Unified Real-Time Analytics for IoT Intrusion Detection; S. Mishra, A. V, R. Singh, and V. K. Singh",
    categories: [1, 3, 5],
  },
  {
    img: TestimonialImg01,
    ...
    company: "Conference",
    content:
        "KNOXRT: Knowledge-Networked Optimization for eXploratory Real-time Training; S. Mishra, J. K., M. Shivakoti, A. V., R. Singh",
    categories: [1, 3, 5],
  },
  {
    img: TestimonialImg01,
    ...
    company: "Conference",
    content:
      "Streamlined Data Pipeline for Real-Time Threat Detection and Model Inference; R. Singh, A. V., S. Mishra, S. K. Singh",
    categories: [1, 2, 4],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Have a look at our currently published work in various conferences and journals.
          </p>
        </div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                ...
                <span>Optimization & Self-Learning AI</span>
              </button>
              {/* Button #5 */}
              <button
